    ...
    try {
      ...
      if (logoFile) {
        ...
        const uploadRes = await fetch(
          `${import.meta.env.VITE_BACKEND_URL || "http://localhost:8000"}/api/users/upload-logo/${uid}`,
          {
            method: "POST",
            body: fd,
          }
      ...
      const patchRes = await fetch(
        `${import.meta.env.VITE_BACKEND_URL || "http://localhost:8000"}/api/users/business/${uid}`,
        {
          method: "PATCH",
