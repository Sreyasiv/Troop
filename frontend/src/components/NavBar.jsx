...
import troopLogo from "../assets/logomain.png"; // Make sure the logo is named correctly
...
const NavBar = () => {
  return  (
    <nav className="w-full bg-[#2c2c2c] px-6 py-3 flex items-center justify-between">
      {/* Logo only - full size, not cropped */}
      ...
      <Link to="/clubs" className="hover:text-[#D4852D]">Clubs</Link>
        <Link to="/market" className="hover:text-[#D4852D]">Market</Link>
        <Link to="/help" className="hover:text-[#D4852D]">Help</Link>
